# Generated by Powerlevel10k configuration wizard on 2020-08-05 at 12:29 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=77
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=220
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=85
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='\uf9ce'
  ...
  typeset -g POWERLEVEL9K_VCS_STASH_ICON='\ufb6f'
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${(g::)POWERLEVEL9K_VCS_AHEAD_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
